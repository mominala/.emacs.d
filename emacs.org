...
** cpp
   #+BEGIN_SRC emacs-lisp :tangle yes
     ...
     (add-hook 'c++-mode-hook 'c-c++-company-setup)
     (add-hook 'c-ts-mode-hook 'c-c++-company-setup)
     (add-hook 'c++-ts-mode-hook 'c-c++-company-setup)
     ...
     (use-package eglot
       ...
       (add-to-list 'eglot-server-programs
                    '((c++-mode c-mode c++-ts-mode c-ts-mode) "/usr/bin/clangd" "--query-driver=~/.nix-profile/bin/clang**" "-background-index" "--log=verbose" "--folding-ranges"))
...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package treesit-auto
    ...
    :config
    (setq treesit-auto-langs '(c++ c just nix terraform))
    ;; (treesit-auto-add-to-auto-mode-alist 'all)
    (global-treesit-auto-mode)
    (add-hook
     'c++-ts-mode-hook
     (lambda () (setq-local indent-line-function #'c-indent-line)))
    )
